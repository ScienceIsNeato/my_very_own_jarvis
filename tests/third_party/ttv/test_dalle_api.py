...
def test_dalle_basic_generation():
    """
    Simple test to verify DALL-E API is working and returning images.
    This test:
    ...
    test_prompt = "A simple test image of a red apple on a white background, digital art style"
    ...
    try:
        ...
        Logger.print_info(f"Response data: {json.dumps(response.model_dump(), indent=2)}")
