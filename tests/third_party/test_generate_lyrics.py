...
def test_generate_lyrics():
    ...
    for duration in test_durations:
        ...
        # Theme validation - look for multiple themes to be more robust
        key_themes = [
            "knight", "dragon", "quest", "adventure", "journey", "magic", 
            "brave", "mystical", "city", "friends", "wise", "fierce", "giant"
        ]
        ...
        Logger.print_info(f"✓ All validation checks passed for {duration}s duration test.")

    Logger.print_info("✓ All duration tests completed successfully.") 